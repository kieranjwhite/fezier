...
LOCAL_MODULE    := tiles
LOCAL_SRC_FILES := render.c rendering/draw.c rtu.c minunit.c

#for debugging
LOCAL_CFLAGS += -O0 -gdwarf-2 -g3 -mfloat-abi=softfp -mfpu=vfpv3 -mfpu=neon -ftree-vectorize -DNDK -DHAVE_TYPEOF -DHAVE_BUILTIN_CHOOSE_EXPR -DHAVE_BUILTIN_TYPES_COMPATIBLE -std=c99
